    ...
    return (
        <footer className="bg-transparent text-white py-6 mt-8">
            <div className="container mx-auto text-center px-4">
                ...
                <div className="flex justify-center space-x-8 mt-6 sm:space-x-6 xs:space-x-4">
                    {socialLinks.map((link) => {
                        ...
                        return (
                            <a
                                ...
                                className="w-12 h-12 rounded-full bg-white/10 dark:bg-gray-700 flex items-center justify-center hover:bg-white/20 transition sm:w-10 sm:h-10 xs:w-9 xs:h-9"
                ...
                <div className="flex justify-center mt-4">
                    <ul className="flex space-x-8 text-lg sm:space-x-6 xs:space-x-4 xs:text-base flex-wrap justify-center">
                        <li>
